...
function ManageTemp() {
  ...
  return (
   <>
        <Button className='mt-0 mx-2 btn btn-sm' style={{ fontWeight: 'bold', fontFamily: 'Montserrat', backgroundColor: '#2F80ED'}} onClick={() => setModalShow(true)}>Manage Templates</Button>
