...
function CreateTag() {
  ...
  return (
    <>
        ...
        <p type='button' className='mt-3 mx-2' style={{ textDecorationLine: 'underline', color: '#2f80ed', fontWeight: 'bold', fontFamily: 'Montserrat'}} onClick= {() => setModalShow(true)}>Create New Tags</p>
